...
// this function to put data in local Database using key
  ...
  // this function to get data already saved in local Database
...
// remove data using specific key
  ...
  // this function to put data in local data base using key
   Future<dynamic> put({
    required String key,
